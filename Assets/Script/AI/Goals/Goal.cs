...
public class Goal {
	...
	Dictionary<string,List<evaluationMethod>> evalMethods;
	Dictionary<string,List<immediateExecute>> immExecMethods;
	Dictionary<evaluationMethod,executionMethod> execMethods;
	...
	protected void registerEvent(string eventType, evaluationMethod evalMethod, executionMethod execMethod) {
		...
		execMethods.Add(evalMethod, execMethod);
	}
